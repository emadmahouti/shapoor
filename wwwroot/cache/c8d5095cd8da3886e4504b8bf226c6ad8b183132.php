                    ...
                    <div class="list-group">
                        <?php for($i = 0; $i < count($data); $i++): ?>
                            <a class="list-group-item list-group-item-action"
                               :class="{active: <?php echo e($i); ?> == 0}"
                               data-toggle="list"
                               role="tab"
                               id="list-<?php echo e($i); ?>"
                               href="#<?php echo e($data[$i]->phone_number); ?>"
                               v-on:click="selectUser(<?php echo e($i); ?>, <?php echo e($data[$i]); ?>)">
                                <?php echo e($data[$i]->phone_number); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Apache24\docs\shapoor.cafeoperations.ir\app\Views/message/dashboard.blade.php ENDPATH**/ ?>